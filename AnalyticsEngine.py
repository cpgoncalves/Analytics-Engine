...
def statistics_quantitative(X,target_name):
    ...
    # return the p-value of the kurtosis and skewness
    return p_value_kurtosis, p_value_skewness
...
def one_mean(df, # pandas dataframe
    ...
    p_value_kurtosis, p_value_skewness = statistics_quantitative(X,target_name)
...
def two_means_indep(df, # pandas dataframe
    ...
    p_kurtosis_0, p_skewness_0 = statistics_quantitative(X_0,name_0)
    p_kurtosis_1, p_skewness_1 = statistics_quantitative(X_1,name_1)
...
def two_means_paired(df, # pandas dataframe
    ...
    p_kurtosis_1, p_skewness_1 = statistics_quantitative(X_1,target_1)
    p_kurtosis_2, p_skewness_2 = statistics_quantitative(X_2,target_2)
    p_kurtosis_3, p_skewness_3 = statistics_quantitative(D,"Difference")
    
      
    # evaluate the normality assumption
    assumption = evaluate_normality_assumption(D, 'Difference',
                                               p_kurtosis_3,p_skewness_3,nan)
...
def anova(df, # pandas dataframe
    ...
    for i in range (0,num_variables):
        ...
        p_value_kurtosis, p_value_skewness = statistics_quantitative(X_i,
                                                                     name)
        assumption = evaluate_normality_assumption(X_i,
                                                   name,
                                                   p_value_kurtosis,
                                                   p_value_skewness,
                                                   nan)
